...
export class Sacrifice {
  ...
  static get nextBoost() {
    const nd1Amount = AntimatterDimension(1).amount.clampMax(Decimal.pow(10, 1e25));
...
export function sacrificeReset() {
  ...
  player.sacrificed = player.sacrificed.plus(AntimatterDimension(1).amount).clampMax(Decimal.pow(10, 1e25));
