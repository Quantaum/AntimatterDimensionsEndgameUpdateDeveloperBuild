export const normalAchievements = [
  ...
  },
  {
    ...
    progress: () => {
      let maxR = 0;
      for (let test = 0; test < 750; test++) {
        if (DimBoost.bulkRequirement(test+1).isSatisfied) maxR++;
      }
      return Achievement(117).isUnlocked ? DC.D1 : Decimal.clamp(new Decimal(maxR).div(750), 0, 1);
    }
  },
  {
    id: 118,
